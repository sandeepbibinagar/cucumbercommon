 ...
 */
package com.experian.automation.saas.steps.security.helpers;
...
public final class BurpSuiteRestClient {
  ...
  private String burpScannerLogin(String burpEnterpriseUrl, String burpScannerUsername, char[] burpScannerPassword) {
    ...
    Response response = client.target(burpEnterpriseUrl + BURP_SUITE_LOGIN_URL).request(JSON_CONTENT_TYPE).post(
        Entity.json(input));
   ...
   */
  public String burpScannerCreateSite(String targetEndpoint, String applicationName, String appUsername,
      char[] appPassword) {
