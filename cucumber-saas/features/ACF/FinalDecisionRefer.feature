@run
Feature: Final Decision Refer through the REST api
  In order to obtain final decision Refer for an application,
  As an ACF user,
  I want to send a POST request with  information for one applicant and receive a valid response with final decision Refer for the application.|
