@run
Feature: Final Decision APPROVE through the REST api
  In order to obtain a final decision APPROVE for an application,
  As an ACF user,
  I want to send a POST request with  information for one applicant and receive a valid response with final decision APPROVE for the application.
