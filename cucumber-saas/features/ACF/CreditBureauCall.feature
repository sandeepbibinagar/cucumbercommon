Feature: Credit Bureau Calls through the REST api
  ...
  Scenario: ID:EXCB03 As a User I want to CREATE an application through CLIENT SYSTEM to get indication for Experian credit bureau being swiched off.
 # Test-ID: 4817941
 # Use-Case: ACF
 # Priority: P3
 # The date format should be mm/dd/yyyy
 ...
 # The date format should be mm/dd/yyyy
  ...
  Scenario: ID:EQCB02 As a User I want to CREATE an application through CLIENT SYSTEM to get indication for Equifax credit bureau being swiched off.
    # Test-ID: 5010785
    # Use-Case: ACF
    # Priority: P3
    # The date format should be mm/dd/yyyy
  ...
  Scenario: ID:TUCB02 As a User I want to CREATE an application through CLIENT SYSTEM to get indication for TransUnion credit bureau being swiched off.
 # Test-ID: 5010787
 # Use-Case: ACF
 # Priority: P3
 # The date format should be mm/dd/yyyy
