Feature: Pre Bureau Decline Decision through the REST api
  In order to obtain a pre-bureau decision for an application,
  As an ACF user,
  I want to send a POST request with  information for one applicant and receive a valid response with pre-bureau DECLINE decision for the application.
