@run
Feature: Final Decision Decline through the REST api
  In order to obtain a final decision Decline for an application,
  As an ACF user,
  I want to send a POST request with  information for one applicant and receive a valid response with final decision Decline for the application.|
