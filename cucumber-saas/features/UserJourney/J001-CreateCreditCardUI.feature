Feature: User Journey - Create Credit Card TP via UI
...
#   Populating Tactical Parameters
    And I update parameter Product_TP - TP - Product_TP Search description: Product Type ,effective from: 12/01/2017 to
