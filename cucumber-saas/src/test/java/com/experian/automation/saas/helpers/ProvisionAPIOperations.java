...
public class ProvisionAPIOperations {
  ...
  public boolean createService(String serviceName, String serviceGroupName, String releaseName)
      throws UnirestException {

    int serviceGroupID = getServiceGroupID(serviceGroupName);

    String requestURL = String.format(getRequestURL("create-service-" + serviceName), serviceGroupID);
    String requestBodyData = String.format(getRequestBody("create-service-" + serviceName), serviceGroupName,
                                           releaseName);
  ...
  public boolean waitForServiceStatus(String serviceName, String serviceGroupName, String status, long timeout)
